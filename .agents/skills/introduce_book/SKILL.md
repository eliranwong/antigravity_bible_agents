...
## Instructions
Produce a comprehensive scholarly introduction and overview of a bible book. Address:
1. **Historical Background**: Authorship, date, provenance, and target audience.
2. **Literary Context**: Genre, structure, and style.
3. **Occasion and Purpose**: Why the book was written and the issues it addresses.
4. **Theological Themes**: Core doctrines, covenantal focus, and major teachings.
