...
## Overview
This standalone skill enables any agent to perform a high-quality nt meaning study for a given Bible reference, text, or topic.
...
## Instructions
Explain the core spiritual and theological meaning of a New Testament passage:
1. **Historical-Covenantal Grounding**: How the text reflects the New Covenant established in Christ's blood.
