...
## Overview
This standalone skill enables any agent to perform a high-quality ot themes study for a given Bible reference, text, or topic.
...
## Instructions
Analyze key theological and doctrinal themes in an Old Testament passage:
1. **Doctrinal Identification**: Trace specific themes (e.g., Holiness, Covenant Faithfulness, Law, Exile).
