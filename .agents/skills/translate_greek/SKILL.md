...
# Translate Greek Skill

## Overview
This standalone skill enables any agent to perform a high-quality translate greek study for a given Bible reference, text, or topic.
