...
def main():
    print("Generating comprehensive Pre-Final Overview and Synthesis Audit...")

    overview_content = """# Step 029: Pre-Final Overview and Research Synthesis Audit
...
```mermaid
graph TD
    A["030-final_response.md"] --> B["I. Introduction: The Heartbeat of the Gospel"]
    A --> C["II. Narrative & Historical Context (Nicodemus Dialogue)"]
    A --> D["III. Exegetical Deep-Dive: Original Languages & Keywords"]
    A --> E["IV. Biblical Theology & Canonical Connections"]
    A --> F["V. Systematic Dogmatics: The Sovereign Love of God"]
    A --> G["VI. Pastoral Application, Devotional Reflection & Prayer"]
```
...
"""
    ...
    cmd = [sys.executable, ORCHESTRATOR, "--save-overview", FOLDER, "29", tmp_path]
